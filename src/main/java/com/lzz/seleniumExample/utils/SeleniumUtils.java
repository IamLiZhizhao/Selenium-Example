...
//		log.info("谷歌驱动路径，{}", driverPath);
        ...
        chromePrefs
                .put("printing.print_preview_sticky_settings.appState", "{\"version\":2,\"isGcpPromoDismissed\":false,\"selectedDestinationId\":\"Save as PDF\"");// 打印设置
        chromePrefs
...
//        options.addArguments("--headless"); // 静默下载
